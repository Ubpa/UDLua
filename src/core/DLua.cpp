...
namespace Ubpa::details {
	...
	namespace CppMeta {
		...
		static constexpr auto pre_dec = TSTR("pre_dec");

		using t_deref = decltype(deref);
		using t_pre_inc = decltype(pre_inc);
		using t_pre_dec = decltype(pre_dec);
	}
}
...
template<typename Functor, typename MetaName, std::size_t ID = static_cast<std::size_t>(-1), int LArgNum = -1, bool ToBool = false>
static int f_meta(lua_State * L_) {
	...
	if constexpr (LArgNum != -1) {
		if (L_argnum != LArgNum) {
			return L.error("%s::__%s : The number of arguments is invalid. The function needs %d argument.",
				type_name<Functor>().Data(), MetaName::Data(), LArgNum);
		}
	}
	else {
		if (L_argnum <= 0) {
			return L.error("%s::__%s : The number of arguments is invalid. The function needs >= 1 argument.",
	...
	if (argnum > UDRefl::MaxArgNum) {
		return L.error("%s::__%s : The number of arguments (%d) is greater than UDRefl::MaxArgNum (%d).",
	...
	for (std::size_t i{ 0 }; i < argnum; i++) {
		...
		case LUA_TUSERDATA:
			...
			break;
		default:
			return L.error("%s::__%s : The function doesn't support %s.",
	...
	if (!rst.GetID().Valid()) {
		return L.error("%s::__%s : The function isn't invocable with arguments.",
			type_name<Functor>().Data(),
			MetaName::Data()
		);
	}
...
static const struct luaL_Reg meta_ConstObjectPtr[] = {
	...
	"__eq", &f_meta<UDRefl::ConstObjectPtr, details::Meta::t_eq, UDRefl::StrIDRegistry::MetaID::operator_eq.GetValue(), 2, true>,
	"__le", &f_meta<UDRefl::ConstObjectPtr, details::Meta::t_le, UDRefl::StrIDRegistry::MetaID::operator_le.GetValue(), 2, true>,
	"__lt", &f_meta<UDRefl::ConstObjectPtr, details::Meta::t_lt, UDRefl::StrIDRegistry::MetaID::operator_lt.GetValue(), 2, true>,
	...
	"__deref", &f_meta<UDRefl::ConstObjectPtr, details::CppMeta::t_deref, UDRefl::StrIDRegistry::MetaID::operator_deref.GetValue(), 1>,
	"__pre_inc", &f_meta<UDRefl::ConstObjectPtr, details::CppMeta::t_pre_inc, UDRefl::StrIDRegistry::MetaID::operator_pre_inc.GetValue(), 1>,
	...
	"capacity", details::wrap<&UDRefl::ConstObjectPtr::capacity, UDRefl::ConstObjectPtr>(TSTR("capacity")),
	"key_comp", details::wrap<&UDRefl::ConstObjectPtr::key_comp, UDRefl::ConstObjectPtr>(TSTR("key_comp")),
	"value_comp", details::wrap<&UDRefl::ConstObjectPtr::value_comp, UDRefl::ConstObjectPtr>(TSTR("value_comp")),
	"hash_function", details::wrap<&UDRefl::ConstObjectPtr::hash_function, UDRefl::ConstObjectPtr>(TSTR("hash_function")),
	"key_eq", details::wrap<&UDRefl::ConstObjectPtr::key_eq, UDRefl::ConstObjectPtr>(TSTR("key_eq")),
	"get_allocator", details::wrap<&UDRefl::ConstObjectPtr::get_allocator, UDRefl::ConstObjectPtr>(TSTR("get_allocator")),
...
static const struct luaL_Reg meta_ObjectPtr[] = {
	...
	"__newidex",& f_Ptr_newindex<UDRefl::ObjectPtr>,
	...
	"__eq",& f_meta<UDRefl::ObjectPtr, details::Meta::t_eq, UDRefl::StrIDRegistry::MetaID::operator_eq.GetValue(), 2, true>,
	"__le",& f_meta<UDRefl::ObjectPtr, details::Meta::t_le, UDRefl::StrIDRegistry::MetaID::operator_le.GetValue(), 2, true>,
	"__lt",& f_meta<UDRefl::ObjectPtr, details::Meta::t_lt, UDRefl::StrIDRegistry::MetaID::operator_lt.GetValue(), 2, true>,
	...
	"__deref", &f_meta<UDRefl::ObjectPtr, details::CppMeta::t_deref, UDRefl::StrIDRegistry::MetaID::operator_deref.GetValue(), 1>,
	"__pre_inc",& f_meta<UDRefl::ObjectPtr, details::CppMeta::t_pre_inc, UDRefl::StrIDRegistry::MetaID::operator_pre_inc.GetValue(), 1>,
	...
	"capacity", details::wrap<&UDRefl::ObjectPtr::capacity, UDRefl::ObjectPtr>(TSTR("capacity")),
	"bucket_count", details::wrap<&UDRefl::ObjectPtr::bucket_count, UDRefl::ObjectPtr>(TSTR("bucket_count")),
	"key_comp", details::wrap<&UDRefl::ObjectPtr::key_comp, UDRefl::ObjectPtr>(TSTR("key_comp")),
	"value_comp", details::wrap<&UDRefl::ObjectPtr::value_comp, UDRefl::ObjectPtr>(TSTR("value_comp")),
	"hash_function", details::wrap<&UDRefl::ObjectPtr::hash_function, UDRefl::ObjectPtr>(TSTR("hash_function")),
	"key_eq", details::wrap<&UDRefl::ObjectPtr::key_eq, UDRefl::ObjectPtr>(TSTR("key_eq")),
	"get_allocator", details::wrap<&UDRefl::ObjectPtr::get_allocator, UDRefl::ObjectPtr>(TSTR("get_allocator")),
...
static const struct luaL_Reg meta_SharedConstObject[] = {
	...
	"__eq",&f_meta<UDRefl::SharedConstObject, details::Meta::t_eq, UDRefl::StrIDRegistry::MetaID::operator_eq.GetValue(), 2, true>,
	"__le",&f_meta<UDRefl::SharedConstObject, details::Meta::t_le, UDRefl::StrIDRegistry::MetaID::operator_le.GetValue(), 2, true>,
	"__lt",&f_meta<UDRefl::SharedConstObject, details::Meta::t_lt, UDRefl::StrIDRegistry::MetaID::operator_lt.GetValue(), 2, true>,
	...
	"__deref", &f_meta<UDRefl::SharedConstObject, details::CppMeta::t_deref, UDRefl::StrIDRegistry::MetaID::operator_deref.GetValue(), 1>,
	"__pre_inc", &f_meta<UDRefl::SharedConstObject, details::CppMeta::t_pre_inc, UDRefl::StrIDRegistry::MetaID::operator_pre_inc.GetValue(), 1>,
...
static const struct luaL_Reg meta_SharedObject[] = {
	...
	"__newidex",&f_Ptr_newindex<UDRefl::SharedObject>,
	...
	"__eq",&f_meta<UDRefl::SharedObject, details::Meta::t_eq, UDRefl::StrIDRegistry::MetaID::operator_eq.GetValue(), 2, true>,
	"__le",&f_meta<UDRefl::SharedObject, details::Meta::t_le, UDRefl::StrIDRegistry::MetaID::operator_le.GetValue(), 2, true>,
	"__lt",&f_meta<UDRefl::SharedObject, details::Meta::t_lt, UDRefl::StrIDRegistry::MetaID::operator_lt.GetValue(), 2, true>,
	...
	"__deref", &f_meta<UDRefl::SharedObject, details::CppMeta::t_deref, UDRefl::StrIDRegistry::MetaID::operator_deref.GetValue(), 1>,
	"__pre_inc", &f_meta<UDRefl::SharedObject, details::CppMeta::t_pre_inc, UDRefl::StrIDRegistry::MetaID::operator_pre_inc.GetValue(), 1>,
